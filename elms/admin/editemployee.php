...
<input id="joiningdate" name="joiningdate" class="datepicker" type="tel" value="<?php echo htmlentities($result->joiningdate);?>" required>
</div>
<div class="input-field col m6 s12">
