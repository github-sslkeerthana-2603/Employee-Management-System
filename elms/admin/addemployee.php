...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,FatherName,MotherName,EmailId,Password,Gender,Dob,Department,bloodgroup,reportingto,designation,Address,Phonenumber,agp,basicpay,paylevel,bogmeet,panno,aadharno,bankname,accountno,ifsc,category,Teaching_nonTeaching,FacType,joiningdate,Status) VALUES(:empid,:fname,:lname,:ftname,:mname,:email,:password,:gender,:dob,:department,:bloodgroup,:repoting,:designation,:address,:mobileno,:agp,:basicpay,:paylevel,:bogmeet,:panno,:aadharno,:bankname,:accountno,:ifsc,:category,:teachingnon,:empType,:joiningdate,:status)";
