...
<tr>
      ...
      <?php        for ($i=0;$i<count($table_array);$i++){
                                            if ($table_array[$i]=="$result->EmpId"){?>
                                                <td><a href="../admin/editemployee.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->EmpId);?></a></td>
                                           ...
                                           <?php }else if ($table_array[$i]=="$result->View Details"){ ?> 
                                              <?php if ($page_title=="ADMIN | Dashboard"){ ?>
                                             <td><a style="color:white !important;" href="../admin/leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                             <?php }else if ($page_title=="ADMIN | All Leaves"){?>
                                             <td><a style="color:white !important;" href="../admin/leavesadmin.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                             <?php }else if ($page_title=="REGISTRAR | Dashboard"){?>
                                             <td><a style="color:white !important;" href="../dir-emp-leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                            <?php }else if ($page_title=="REGISTRAR | Staff"){?>
                                             <td><a style="color:white !important;" href="../dirdetails.php?empid=<?php echo htmlentities($result->EmpId);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                            <?php }else if ($page_title=="ADMIN | View Employee"){?>
                                             <td><a style="color:white !important;" href="../admin/view-details.php?empid=<?php echo htmlentities($result->EmpId);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
                                            <?php }else if ($page_title=="HOD | Dashboard" || $page_title=="HEAD | Dashboard"){?>
                                             <td><a style="color:white !important;" href="../hod-emp-leavedetails.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>
 ...
 <td><a href='../admin/editemployee.php?empid=<?php echo htmlentities($result->id);?>'>edit <i class='fa fa-wrench' aria-hidden='true'></i></a><p style='display:inline;'>&nbsp</p><p style='display:inline;'>&nbsp</p><p style='display:inline;'>&nbsp</p><p style='display:inline;'>&nbsp</p>
