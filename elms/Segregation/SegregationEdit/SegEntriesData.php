...
$table_array=array("$result->EmpId","$result->FirstName"." "."$result->LastName","$result->Department","$result->View Details");
}
...
$table_array=array("$result->EmpId","$result->Department","$result->LeaveType", convertDate("$result->PostingDate"),"$result->Status","$result->View Details");
}

if ($page_title=="ADMIN | All Leaves"){
$table_array=array("$result->EmpId","$result->Department",convertDate("$result->FromDate"),convertDate("$result->ToDate"),"$result->LeaveType","$result->Status","$result->View Details");
}
...
$table_array=array("$result->EmpId","$result->LeaveType", convertDate("$result->PostingDate"),"$result->Status","$result->View Details");
}
